...
class TestGetRelativePathToFolderName(unittest.TestCase):
    def test_get_path_relative_to_source(self):
        ...
        expected = pathlib.Path(
            r'spam\eggs\fake.ma')
        _, result = pathutils.get_path_relative_to_folder_name(test_path, 'source')
    ...
    def test_return_none_if_folder_name_not_in_path(self):
        ...
        result_root, result_path = pathutils.get_path_relative_to_folder_name(test_path, 'foo')
    ...
    def test_returns_root(self):
        ...
        expected = pathlib.Path(
            r'C:\foo\bar\source')
        result, _ = pathutils.get_path_relative_to_folder_name(test_path, 'source')
        self.assertEqual(result, expected)